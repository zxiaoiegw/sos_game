...
public class BoardHelpers {
    ...
    public void handleInvalidBoardSize() {
        if (gui.getSimpleGame().isSelected()) {
            ...
            board.setGameMode(new SimpleGameMode());
        } else {
            ...
            board.setGameMode(new GeneralGameMode(board.getBoardSize()));
        }
    }
}